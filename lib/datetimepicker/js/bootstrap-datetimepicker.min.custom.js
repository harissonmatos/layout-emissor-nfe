!function (e) {
    ...
    "indexOf" in Array.prototype || (Array.prototype.indexOf = function (e, t) {
        ...
        for (var i = this.length; t < i; t++) if (t in this && this[t] === e) return t;
        return -1
    });
    var i = function (t, i) {
        var s = this;
    ...
    i.prototype = {
        constructor: i, _events: [], _attachEvents: function () {
            ...
            this.endDate = e || 1 / 0, this.endDate !== 1 / 0 && (this.endDate = n.parseDate(this.endDate, this.format, this.language, this.formatType)), this.update(), this.updateNavArrows()
            ...
            if (!this.isInline) {
                ...
                var i, s, a, n;
                n = this.container instanceof e ? this.container.offset() : e(this.container).offset(), this.component ? (a = (i = this.component.offset()).left, "bottom-left" != this.pickerPosition && "top-left" != this.pickerPosition || (a += this.component.outerWidth() - this.picker.outerWidth())) : a = (i = this.element.offset()).left, a + 310 > document.body.clientWidth && (a = document.body.clientWidth - 310), s = "top-left" == this.pickerPosition || "top-right" == this.pickerPosition ? i.top - this.picker.outerHeight() : i.top + this.height, s -= n.top, a -= n.left, "body" != this.container && (s += document.body.scrollTop), this.picker.css({
                    top: s,
                    left: a,
                    zIndex: 1000
                })
            ...
            for (var e = this.weekStart, t = "<tr>"; e < this.weekStart + 7;) t += '<th class="dow">' + a[this.language].daysMin[e++ % 7] + "</th>";
            t += "</tr>", this.picker.find(".datetimepicker-days thead").append(t)
        }, fillMonths: function () {
            for (var e = "", t = 0; t < 12;) e += '<span class="month">' + a[this.language].monthsShort[t++] + "</span>";
            this.picker.find(".datetimepicker-months td").html(e)
        }, fill: function () {
            if (null != this.date && null != this.viewDate) {
                var i = new Date(this.viewDate), s = i.getUTCFullYear(), h = i.getUTCMonth(), o = i.getUTCDate(),
                    r = i.getUTCHours(), d = i.getUTCMinutes(),
                ...
                (s < l || s > p) && S.addClass("disabled"), s == l && S.slice(0, c + 1).addClass("disabled"), s == p && S.slice(u).addClass("disabled"), T = "", s = 10 * parseInt(s / 10, 10);
                var H = this.picker.find(".datetimepicker-years").find("th:eq(1)").text(s + "-" + (s + 9)).end().find("td");
                s -= 1;
                for (U = -1; U < 11; U++) T += '<span class="year' + (-1 == U || 10 == U ? " old" : "") + (F == s ? " active" : "") + (s < l || s > p ? " disabled" : "") + '">' + s + "</span>", s += 1;
                H.html(T), this.place()
            }
        }, updateNavArrows: function () {
            var e = new Date(this.viewDate), t = e.getUTCFullYear(), i = e.getUTCMonth(), s = e.getUTCDate(),
                a = e.getUTCHours();
            switch (this.viewMode) {
                case 0:
                    this.startDate !== -1 / 0 && t <= this.startDate.getUTCFullYear() && i <= this.startDate.getUTCMonth() && s <= this.startDate.getUTCDate() && a <= this.startDate.getUTCHours() ? this.picker.find(".prev").css({visibility: "hidden"}) : this.picker.find(".prev").css({visibility: "visible"}), this.endDate !== 1 / 0 && t >= this.endDate.getUTCFullYear() && i >= this.endDate.getUTCMonth() && s >= this.endDate.getUTCDate() && a >= this.endDate.getUTCHours() ? this.picker.find(".next").css({visibility: "hidden"}) : this.picker.find(".next").css({visibility: "visible"});
                    break;
                case 1:
                    this.startDate !== -1 / 0 && t <= this.startDate.getUTCFullYear() && i <= this.startDate.getUTCMonth() && s <= this.startDate.getUTCDate() ? this.picker.find(".prev").css({visibility: "hidden"}) : this.picker.find(".prev").css({visibility: "visible"}), this.endDate !== 1 / 0 && t >= this.endDate.getUTCFullYear() && i >= this.endDate.getUTCMonth() && s >= this.endDate.getUTCDate() ? this.picker.find(".next").css({visibility: "hidden"}) : this.picker.find(".next").css({visibility: "visible"});
                    break;
                case 2:
            ...
            if (t.preventDefault(), t.stopPropagation(), !this.wheelPause) {
                this.wheelPause = !0;
                var i = t.originalEvent.wheelDelta, s = i > 0 ? 1 : 0 === i ? 0 : -1;
                ...
                switch (s[0].nodeName.toLowerCase()) {
                    case"th":
                        switch (s[0].className) {
                            ...
                            case"today":
                                var h = new Date;
                                (h = t(h.getFullYear(), h.getMonth(), h.getDate(), h.getHours(), h.getMinutes(), h.getSeconds(), 0)) < this.startDate ? h = this.startDate : h > this.endDate && (h = this.endDate), this.viewMode = this.startViewMode, this.showMode(0), this._setDate(h), this.fill(), this.autoclose && this.hide()
                        }
                        break;
                    case"span":
                        if (!s.is(".disabled")) {
                            var o = this.viewDate.getUTCFullYear(), r = this.viewDate.getUTCMonth(),
                                d = this.viewDate.getUTCDate(), l = this.viewDate.getUTCHours(),
                                c = this.viewDate.getUTCMinutes(), p = this.viewDate.getUTCSeconds();
                    ...
                    case"td":
                        if (s.is(".day") && !s.is(".disabled")) {
                            var d = parseInt(s.text(), 10) || 1, o = this.viewDate.getUTCFullYear(),
                                r = this.viewDate.getUTCMonth(), l = this.viewDate.getUTCHours(),
                                c = this.viewDate.getUTCMinutes(), p = this.viewDate.getUTCSeconds();
                            s.is(".old") ? 0 === r ? (r = 11, o -= 1) : r -= 1 : s.is(".new") && (11 == r ? (r = 0, o += 1) : r += 1), this.viewDate.setUTCFullYear(o), this.viewDate.setUTCMonth(r, d), this.element.trigger({
                                type: "changeDay",
                                date: this.viewDate
            ...
            if (t = t > 0 ? 1 : -1, 1 == o) s = -1 == t ? function () {
                return a.getUTCMonth() == h
            } : function () {
                return a.getUTCMonth() != i
            }, i = h + t, a.setUTCMonth(i), (i < 0 || i > 11) && (i = (i + 12) % 12); else {
                for (var r = 0; r < o; r++) a = this.moveMonth(a, t);
            ...
            if (this.picker.is(":not(:visible)")) 27 == e.keyCode && this.show(); else {
                ...
                if (a) {
                    var h;
                    this.isInput ? h = this.element : this.component && (h = this.element.find("input")), h && h.change(), this.element.trigger({
                        type: "changeDate",
                        date: this.date
                    })
                }
    ...
    e.fn.datetimepicker = function (t) {
        ...
        return this.each(function () {
            ...
            if (h || n.data("datetimepicker", h = new i(this, e.extend({}, e.fn.datetimepicker.defaults, o))), "string" == typeof t && "function" == typeof h[t] && void 0 !== (a = h[t].apply(h, s))) return !1
        }), void 0 !== a ? a : this
    ...
    var a = e.fn.datetimepicker.dates = {
        ...
        parseFormat: function (e, t) {
            var i = e.replace(this.validParts(t), "\0").split("\0"), s = e.match(this.validParts(t));
        ...
        parseDate: function (s, n, h, o) {
            ...
            if (/^\d{4}\-\d{1,2}\-\d{1,2}$/.test(s) && (n = this.parseFormat("yyyy-mm-dd", o)), /^\d{4}\-\d{1,2}\-\d{1,2}[T ]\d{1,2}\:\d{1,2}$/.test(s) && (n = this.parseFormat("yyyy-mm-dd hh:ii", o)), /^\d{4}\-\d{1,2}\-\d{1,2}[T ]\d{1,2}\:\d{1,2}\:\d{1,2}[Z]{0,1}$/.test(s) && (n = this.parseFormat("yyyy-mm-dd hh:ii:ss", o)), /^[-+]\d+[dmwy]([\s,]+[-+]\d+[dmwy])*$/.test(s)) {
                var d, l = /([-+]\d+)([dmwy])/, c = s.match(/([-+]\d+)([dmwy])/g);
                s = new Date;
                for (w = 0; w < c.length; w++) switch (m = l.exec(c[w]), d = parseInt(m[1]), m[2]) {
                    case"d":
            ...
            var p, u, m, c = s && s.toString().match(this.nonpunctuation) || [], s = new Date(0, 0, 0, 0, 0, 0, 0),
                v = {},
            ...
            if (g.M = g.MM = g.mm = g.m, g.dd = g.d, g.P = g.p, s = t(s.getFullYear(), s.getMonth(), s.getDate(), s.getHours(), s.getMinutes(), s.getSeconds()), c.length == n.parts.length) {
                for (var w = 0, D = n.parts.length; w < D; w++) {
                    if (p = parseInt(c[w], 10), m = n.parts[w], isNaN(p)) switch (m) {
                        case"MM":
                        ...
                        case"M":
                            u = e(a[h].monthsShort).filter(function () {
                                var e = this.slice(0, c[w].length), t = c[w].slice(0, e.length);
                ...
                for (var y, w = 0; w < f.length; w++) (y = f[w]) in v && !isNaN(v[y]) && g[y](s, v[y])
            }
            return s
        },
        formatDate: function (t, i, s, h) {
            ...
            if ("standard" == h) o = {
                ...
                i: t.getUTCMinutes(),
                s: t.getUTCSeconds()
            }, 2 == a[s].meridiem.length ? o.H = o.h % 12 == 0 ? 12 : o.h % 12 : o.H = o.h, o.HH = (o.H < 10 ? "0" : "") + o.H, o.P = o.p.toUpperCase(), o.hh = (o.h < 10 ? "0" : "") + o.h, o.ii = (o.i < 10 ? "0" : "") + o.i, o.ss = (o.s < 10 ? "0" : "") + o.s, o.dd = (o.d < 10 ? "0" : "") + o.d, o.mm = (o.m < 10 ? "0" : "") + o.m; else {
            ...
            for (var t = [], r = e.extend([], i.separators), d = 0, l = i.parts.length; d < l; d++) r.length && t.push(r.shift()), t.push(o[i.parts[d]]);
